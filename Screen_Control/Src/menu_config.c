...
const MenuItem main_menu_items[] = {
    {"1. 工作模式选择", MENU_TYPE_SUBMENU, NULL, work_mode_items, sizeof(work_mode_items)/sizeof(MenuItem)},
    {"2. 工作参数设置", MENU_TYPE_SUBMENU, NULL, work_params_items, sizeof(work_params_items)/sizeof(MenuItem)},
    {"3. 控制器参数", MENU_TYPE_SUBMENU, NULL, ctrl_params_items, sizeof(ctrl_params_items)/sizeof(MenuItem)}
};
